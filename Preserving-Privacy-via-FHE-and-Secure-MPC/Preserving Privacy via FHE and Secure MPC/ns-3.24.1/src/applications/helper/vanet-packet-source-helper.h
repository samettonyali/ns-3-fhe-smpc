/* 
 * File:   vanet-packet-source-helper.h
 * Author: samet
 *
 * Created on August 17, 2016, 4:43 PM
 */

#ifndef VANET_PACKET_SOURCE_HELPER_H
#define	VANET_PACKET_SOURCE_HELPER_H
 ...
 */
class VanetPacketSourceHelper
{
public:
  /**
   * Create VanetPacketSourceHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IP address of the remote udp echo server
   * \param port The port number of the remote udp echo server
   */
  VanetPacketSourceHelper (Address ip, uint16_t port);
  /**
   * Create VanetPacketSourceHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  VanetPacketSourceHelper (Ipv4Address ip, uint16_t port);
  /**
   * Create VanetPacketSourceHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  VanetPacketSourceHelper (Ipv6Address ip, uint16_t port);
...
#endif	/* VANET_PACKET_SOURCE_HELPER_H */
