...
#ifndef SMPC_PACKET_SOURCE_HELPER_H
#define SMPC_PACKET_SOURCE_HELPER_H
...
public:
   ...
   *        to.
   */
  SmpcPacketSourceHelper (std::string protocol, Address address);
...
#endif /* SMPC_PACKET_SOURCE_HELPER_H */
