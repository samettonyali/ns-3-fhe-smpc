 ...
 */
#ifndef AGG_SENSOR_HELPER_H
#define AGG_SENSOR_HELPER_H
...
public:
   ...
   *
   */
  AggSensorHelper (std::string protocol, Address address);

  AggSensorHelper (std::string protocol, Address address, uint32_t child);

  AggSensorHelper (std::string protocol, Address address, uint32_t child, Address parentAddress);
