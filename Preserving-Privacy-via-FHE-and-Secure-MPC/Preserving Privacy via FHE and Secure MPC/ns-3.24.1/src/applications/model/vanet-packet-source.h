/* 
 * File:   vanet-packet-source.h
 * Author: samet
 *
 * Created on August 17, 2016, 4:10 PM
 */

#ifndef VANET_PACKET_SOURCE_H
#define	VANET_PACKET_SOURCE_H
 ...
 */
class VanetPacketSource : public Application 
{
public:
  /**
