...
/* 
 * File:   smpc-packet-sink.h
 * Author: samet
 *
 * Created on January 19, 2016, 1:03 PM
 */

#ifndef SMPC_PACKET_SINK_H
#define SMPC_PACKET_SINK_H
 ...
 */
class SmpcPacketSink : public Application
{
public:
  static TypeId GetTypeId (void);
  SmpcPacketSink ();

  virtual ~SmpcPacketSink ();
