 ...
 */
#ifndef LTE_AGGREGATOR_HELPER_H
#define LTE_AGGREGATOR_HELPER_H
...
public:
   ...
   *
   */
  LteAggregatorHelper (std::string protocol, Address address);

  LteAggregatorHelper (std::string protocol, Address address, uint32_t child);

  LteAggregatorHelper (std::string protocol, Address address, uint32_t child, Address parentAddress);
