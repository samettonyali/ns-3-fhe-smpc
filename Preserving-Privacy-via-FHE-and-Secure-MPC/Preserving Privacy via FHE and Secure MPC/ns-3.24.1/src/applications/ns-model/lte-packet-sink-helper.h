 ...
 */
#ifndef LTE_PACKET_SINK_HELPER_H
#define LTE_PACKET_SINK_HELPER_H
...
public:
   ...
   *
   */
  LtePacketSinkHelper (std::string protocol, Address address);
...
#endif /* LTE_PACKET_SINK_HELPER_H */
