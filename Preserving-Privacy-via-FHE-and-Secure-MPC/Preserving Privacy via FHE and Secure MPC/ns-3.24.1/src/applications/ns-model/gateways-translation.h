...
#ifndef GATEWAYS_TRANSLATION_H
#define GATEWAYS_TRANSLATION_H
 ...
 */
class GatewaysTranslation : public Application
{
public:
  static TypeId GetTypeId (void);
  GatewaysTranslation ();

  virtual ~GatewaysTranslation ();
...
private:
  ...
  void ForwardToDestination(Ptr<Packet> packet);
  ...
  Ptr<Socket>     m_outSocket;       //outgoing socket
