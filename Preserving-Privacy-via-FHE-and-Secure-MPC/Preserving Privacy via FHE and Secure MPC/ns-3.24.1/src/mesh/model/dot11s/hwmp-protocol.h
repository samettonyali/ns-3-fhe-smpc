...
public:
  ...
  uint16_t ReportPathError (); // 11/07/2014 by nico
  uint16_t ReportPathErrorLink (); // 11/07/2014 by nico
  uint16_t ReportPathErrorForward (); // 11/07/2014 by nico
  uint16_t ReportPathErrorPath (); // 11/07/2014 by nico
  ...
  void SetReportHwmpTcpInterfaceCallback(Callback<void,uint32_t,Time> cb);
...
private:
  ...
  struct Statistics
  {
    ...
    uint16_t iPerrLink;
    uint16_t iPerrPath;
    uint16_t iPerrForward;

    void Print (std::ostream & os) const;
    uint16_t GetPathErrorInfo ();  // 11/07/11 by nico 
    uint16_t GetPathErrorInfoLink ();  // 11/07/11 by nico 
    uint16_t GetPathErrorInfoForward ();  // 11/07/11 by nico
    uint16_t GetPathErrorInfoPath ();  // 11/07/11 by nico 
    Statistics ();
  };
  Statistics m_stats;
  ///\}
  ...
  Callback <void, uint32_t, Time> m_reportHwmpTcpInterfaceCallback;
};
} // namespace dot11s
} // namespace ns3
#endif
